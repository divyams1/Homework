...
describe Dessert do
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect { Dessert.new("brownie", "10", "Bob")}.to raise_error(ArgumentError)
    end 
  end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do 
      ...
      expect(brownie.ingredients).to eq(["eggs", "milk", "chocolate", "cream"])
      brownie.mix! 
      expect(brownie.ingredients).to_not eq(["eggs", "milk", "chocolate", "cream"])
    end 
  end
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do 
      ...
      expect(brownie.serve).to eq("Bob has made 10 brownies!")
    end 
  end
